...
This is the traditional model of Order vs. Chaos where chaos is seen as subversion or the freedom to buck authority and being Lawful is seend as following authority and their laws.
...
Ensuring that equality instead of fairness.  Opposite of Grace. 

This is justice over judgment.  This is law over forgiveness. 

This foundation operates in tension with the Fairness or Proportionality and is a different take on the results observed in that domain.

#### Honesty

Does communication match reality as seen from an impartial observer; opposite of Lying.
